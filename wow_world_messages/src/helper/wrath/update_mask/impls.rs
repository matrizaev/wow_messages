...
impl UpdatePlayerBuilder {
    ...
    pub fn set_player_buyback_price(mut self, slot: crate::wrath::BuybackSlot, v: i32) -> Self {
        let offset = 1201 + slot.as_int() as u16 - 74;
        self.set_int(offset, v);
        self
    }

    pub fn set_player_buyback_timestamp(mut self, slot: crate::wrath::BuybackSlot, v: i32) -> Self {
        let offset = 1213 + slot.as_int() as u16 - 74;
        self.set_int(offset, v);
        self
    }
...
impl UpdatePlayer {
    ...
    pub fn set_player_buyback_price(&mut self, slot: crate::wrath::BuybackSlot, v: i32) {
        let offset = 1201 + slot.as_int() as u16 - 74;
        self.set_int(offset, v);
    }

    pub fn player_buyback_price(&self, slot: crate::wrath::BuybackSlot) -> Option<i32> {
        let offset = 1201 + slot.as_int() as u16 - 74;
        self.get_int(offset)
    }

    pub fn set_player_buyback_timestamp(&mut self, slot: crate::wrath::BuybackSlot, v: i32) {
        let offset = 1213 + slot.as_int() as u16 - 74;
        self.set_int(offset, v);
    }

    pub fn player_buyback_timestamp(&self, slot: crate::wrath::BuybackSlot) -> Option<i32> {
        let offset = 1213 + slot.as_int() as u16 - 74;
        self.get_int(offset)
    }
