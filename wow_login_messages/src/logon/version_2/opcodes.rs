...
impl ClientOpcodeMessage {
    ...
    pub fn read<R: std::io::Read>(mut r: R) -> Result<Self, crate::errors::ExpectedOpcodeError> {
        ...
        match opcode {
            0x00 => Ok(Self::CMD_AUTH_LOGON_CHALLENGE(
                CMD_AUTH_LOGON_CHALLENGE_Client::read::<R, crate::private::Internal>(r)?,
            )),
            0x01 => Ok(Self::CMD_AUTH_LOGON_PROOF(
                CMD_AUTH_LOGON_PROOF_Client::read::<R, crate::private::Internal>(r)?,
            )),
            0x02 => Ok(Self::CMD_AUTH_RECONNECT_CHALLENGE(
                CMD_AUTH_RECONNECT_CHALLENGE_Client::read::<R, crate::private::Internal>(r)?,
            )),
            0x03 => Ok(Self::CMD_AUTH_RECONNECT_PROOF(
                CMD_AUTH_RECONNECT_PROOF_Client::read::<R, crate::private::Internal>(r)?,
            )),
            0x10 => Ok(Self::CMD_REALM_LIST(CMD_REALM_LIST_Client::read::<
                R,
                crate::private::Internal,
            >(r)?)),
            0x32 => Ok(Self::CMD_XFER_ACCEPT),
            0x33 => Ok(Self::CMD_XFER_RESUME(CMD_XFER_RESUME::read::<
                R,
                crate::private::Internal,
            >(r)?)),
    ...
    #[cfg(feature = "tokio")]
    pub async fn tokio_read<R: tokio::io::AsyncReadExt + Unpin + Send>(
        mut r: R,
    ) -> Result<Self, crate::errors::ExpectedOpcodeError> {
        let opcode = crate::util::tokio_read_u8_le(&mut r).await?;
        match opcode {
            0x00 => Ok(Self::CMD_AUTH_LOGON_CHALLENGE(
                CMD_AUTH_LOGON_CHALLENGE_Client::tokio_read::<R, crate::private::Internal>(r)
                    .await?,
            )),
            0x01 => Ok(Self::CMD_AUTH_LOGON_PROOF(
                CMD_AUTH_LOGON_PROOF_Client::tokio_read::<R, crate::private::Internal>(r).await?,
            )),
            0x02 => Ok(Self::CMD_AUTH_RECONNECT_CHALLENGE(
                CMD_AUTH_RECONNECT_CHALLENGE_Client::tokio_read::<R, crate::private::Internal>(r)
                    .await?,
            )),
            0x03 => Ok(Self::CMD_AUTH_RECONNECT_PROOF(
                CMD_AUTH_RECONNECT_PROOF_Client::tokio_read::<R, crate::private::Internal>(r)
                    .await?,
            )),
            0x10 => Ok(Self::CMD_REALM_LIST(
                CMD_REALM_LIST_Client::tokio_read::<R, crate::private::Internal>(r).await?,
            )),
            0x32 => Ok(Self::CMD_XFER_ACCEPT),
            0x33 => Ok(Self::CMD_XFER_RESUME(
                CMD_XFER_RESUME::tokio_read::<R, crate::private::Internal>(r).await?,
            )),
            0x34 => Ok(Self::CMD_XFER_CANCEL),
            opcode => Err(crate::errors::ExpectedOpcodeError::Opcode(opcode as u32)),
        }
    ...
    pub async fn astd_read<R: async_std::io::ReadExt + Unpin + Send>(
        mut r: R,
    ) -> Result<Self, crate::errors::ExpectedOpcodeError> {
        let opcode = crate::util::astd_read_u8_le(&mut r).await?;
        match opcode {
            0x00 => Ok(Self::CMD_AUTH_LOGON_CHALLENGE(
                CMD_AUTH_LOGON_CHALLENGE_Client::astd_read::<R, crate::private::Internal>(r)
                    .await?,
            )),
            0x01 => Ok(Self::CMD_AUTH_LOGON_PROOF(
                CMD_AUTH_LOGON_PROOF_Client::astd_read::<R, crate::private::Internal>(r).await?,
            )),
            0x02 => Ok(Self::CMD_AUTH_RECONNECT_CHALLENGE(
                CMD_AUTH_RECONNECT_CHALLENGE_Client::astd_read::<R, crate::private::Internal>(r)
                    .await?,
            )),
            0x03 => Ok(Self::CMD_AUTH_RECONNECT_PROOF(
                CMD_AUTH_RECONNECT_PROOF_Client::astd_read::<R, crate::private::Internal>(r)
                    .await?,
            )),
            0x10 => Ok(Self::CMD_REALM_LIST(
                CMD_REALM_LIST_Client::astd_read::<R, crate::private::Internal>(r).await?,
            )),
            0x32 => Ok(Self::CMD_XFER_ACCEPT),
            0x33 => Ok(Self::CMD_XFER_RESUME(
                CMD_XFER_RESUME::astd_read::<R, crate::private::Internal>(r).await?,
            )),
            0x34 => Ok(Self::CMD_XFER_CANCEL),
            opcode => Err(crate::errors::ExpectedOpcodeError::Opcode(opcode as u32)),
        }
...
impl std::fmt::Display for ClientOpcodeMessage {
    fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
        f.write_str(match self {
            ...
            ClientOpcodeMessage::CMD_AUTH_RECONNECT_CHALLENGE(_) => {
...
impl ServerOpcodeMessage {
    ...
    pub fn read<R: std::io::Read>(mut r: R) -> Result<Self, crate::errors::ExpectedOpcodeError> {
        ...
        match opcode {
            0x00 => Ok(Self::CMD_AUTH_LOGON_CHALLENGE(
                CMD_AUTH_LOGON_CHALLENGE_Server::read::<R, crate::private::Internal>(r)?,
            )),
            0x01 => Ok(Self::CMD_AUTH_LOGON_PROOF(
                CMD_AUTH_LOGON_PROOF_Server::read::<R, crate::private::Internal>(r)?,
            )),
            0x02 => Ok(Self::CMD_AUTH_RECONNECT_CHALLENGE(
                CMD_AUTH_RECONNECT_CHALLENGE_Server::read::<R, crate::private::Internal>(r)?,
            )),
            0x03 => Ok(Self::CMD_AUTH_RECONNECT_PROOF(
                CMD_AUTH_RECONNECT_PROOF_Server::read::<R, crate::private::Internal>(r)?,
            )),
            0x10 => Ok(Self::CMD_REALM_LIST(CMD_REALM_LIST_Server::read::<
                R,
                crate::private::Internal,
            >(r)?)),
            0x30 => Ok(Self::CMD_XFER_INITIATE(CMD_XFER_INITIATE::read::<
                R,
                crate::private::Internal,
            >(r)?)),
            0x31 => Ok(Self::CMD_XFER_DATA(CMD_XFER_DATA::read::<
                R,
                crate::private::Internal,
            >(r)?)),
            opcode => Err(crate::errors::ExpectedOpcodeError::Opcode(opcode as u32)),
    ...
    pub async fn tokio_read<R: tokio::io::AsyncReadExt + Unpin + Send>(
        ...
        match opcode {
            0x00 => Ok(Self::CMD_AUTH_LOGON_CHALLENGE(
                CMD_AUTH_LOGON_CHALLENGE_Server::tokio_read::<R, crate::private::Internal>(r)
                    .await?,
            )),
            0x01 => Ok(Self::CMD_AUTH_LOGON_PROOF(
                CMD_AUTH_LOGON_PROOF_Server::tokio_read::<R, crate::private::Internal>(r).await?,
            )),
            0x02 => Ok(Self::CMD_AUTH_RECONNECT_CHALLENGE(
                CMD_AUTH_RECONNECT_CHALLENGE_Server::tokio_read::<R, crate::private::Internal>(r)
                    .await?,
            )),
            0x03 => Ok(Self::CMD_AUTH_RECONNECT_PROOF(
                CMD_AUTH_RECONNECT_PROOF_Server::tokio_read::<R, crate::private::Internal>(r)
                    .await?,
            )),
            0x10 => Ok(Self::CMD_REALM_LIST(
                CMD_REALM_LIST_Server::tokio_read::<R, crate::private::Internal>(r).await?,
            )),
            0x30 => Ok(Self::CMD_XFER_INITIATE(
                CMD_XFER_INITIATE::tokio_read::<R, crate::private::Internal>(r).await?,
            )),
            0x31 => Ok(Self::CMD_XFER_DATA(
                CMD_XFER_DATA::tokio_read::<R, crate::private::Internal>(r).await?,
            )),
            opcode => Err(crate::errors::ExpectedOpcodeError::Opcode(opcode as u32)),
        }
    }
    ...
    pub async fn astd_read<R: async_std::io::ReadExt + Unpin + Send>(
        ...
        match opcode {
            0x00 => Ok(Self::CMD_AUTH_LOGON_CHALLENGE(
                CMD_AUTH_LOGON_CHALLENGE_Server::astd_read::<R, crate::private::Internal>(r)
                    .await?,
            )),
            0x01 => Ok(Self::CMD_AUTH_LOGON_PROOF(
                CMD_AUTH_LOGON_PROOF_Server::astd_read::<R, crate::private::Internal>(r).await?,
            )),
            0x02 => Ok(Self::CMD_AUTH_RECONNECT_CHALLENGE(
                CMD_AUTH_RECONNECT_CHALLENGE_Server::astd_read::<R, crate::private::Internal>(r)
                    .await?,
            )),
            0x03 => Ok(Self::CMD_AUTH_RECONNECT_PROOF(
                CMD_AUTH_RECONNECT_PROOF_Server::astd_read::<R, crate::private::Internal>(r)
                    .await?,
            )),
            0x10 => Ok(Self::CMD_REALM_LIST(
                CMD_REALM_LIST_Server::astd_read::<R, crate::private::Internal>(r).await?,
            )),
            0x30 => Ok(Self::CMD_XFER_INITIATE(
                CMD_XFER_INITIATE::astd_read::<R, crate::private::Internal>(r).await?,
            )),
            0x31 => Ok(Self::CMD_XFER_DATA(
                CMD_XFER_DATA::astd_read::<R, crate::private::Internal>(r).await?,
            )),
            opcode => Err(crate::errors::ExpectedOpcodeError::Opcode(opcode as u32)),
        }
    }
...
impl std::fmt::Display for ServerOpcodeMessage {
    fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
        f.write_str(match self {
            ...
            ServerOpcodeMessage::CMD_AUTH_RECONNECT_CHALLENGE(_) => {
